...
class HandGestureDetector(QThread):
    ...
    current_gesture_signal = pyqtSignal(list)
        ...
        while self._run_flag:
            ...
            if results.multi_hand_landmarks is not None:
                for hand_landmarks, handedness in zip(results.multi_hand_landmarks,
                    ...
                    self.current_gesture_signal.emit([self.keypoint_classifier_labels[hand_sign_id], self.point_history_classifier_labels[most_common_fg_id[0][0]]])
            else:
                self.point_history.append([0, 0])
