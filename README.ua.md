...
<h3 align="center">Віртуальний асистент v1.0</h3>
...
Налаштування у графічному інтерфейсі (GUI)
*  ```
   Мова: зміна мови асистента
   ```
*  ```
   Час очікування: кількість секунд, протягом яких асистент буде слухати ваші команди після синтезу останньої відповіді на команду
   ```
*  ```
   Стоп слова: якщо ваша фраза містить будь-яке з "Стоп слів", програма буде завершена
   ```
